...
const Transitions BinaryMoveGenerator::getMoves(const Chesslib::Board & board) {
    ...
    precashed_entries_.clear();
    precashed_legal_entries_.clear();

    precashed_entries_.reserve(150);
    precashed_legal_entries_.reserve(150);
